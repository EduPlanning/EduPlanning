...
<div class="stats-grid" id="statsGrid">
    <div class="stat-card">
        ...
        <div class="stat_info"><p>Enseignants</p><h3 id="statEnseignants">—</h3></div>
    </div>
    <div class="stat-card">
        <div class="stat_icon green"><i class='bx bx-group'></i></div>
        <div class="stat_info"><p>Étudiants</p><h3 id="statEtudiants">—</h3></div>
    </div>
    <div class="stat-card">
        <div class="stat_icon orange"><i class='bx bx-building'></i></div>
        <div class="stat_info"><p>Salles actives</p><h3 id="statSalles">—</h3></div>
    </div>
    <div class="stat-card">
        <div class="stat_icon blue"><i class='bx bx-calendar'></i></div>
        <div class="stat_info"><p>Créneaux total</p><h3 id="statCreneaux">—</h3></div>
    </div>
    <div class="stat-card">
        <div class="stat_icon red"><i class='bx bx-error-alt'></i></div>
        <div class="stat_info"><p>Conflits détectés</p><h3 id="statConflits">—</h3></div>
    </div>
    <div class="stat-card">
        <div class="stat_icon green"><i class='bx bx-collection'></i></div>
        <div class="stat_info"><p>Groupes</p><h3 id="statGroupes">—</h3></div>
    </div>
</div>
...
<div style="display:grid;grid-template-columns:1fr 1fr;gap:1rem;margin-bottom:1.5rem" id="chartsRow">
    <div class="card">
        <div class="card-header"><h2><i class='bx bx-bar-chart-alt-2'></i> Occupation des salles (heures)</h2></div>
        <div class="chart-container" id="occChart"></div>
    </div>

    <div class="card">
        <div class="card-header"><h2><i class='bx bx-info-circle'></i> Informations système</h2></div>
        <div class="card-body">
...
<div class="card" id="quickActionsCard" style="display:none">
    <div class="card-header"><h2>Accès rapide — Administration</h2></div>
    <div class="card-body">
...
document.addEventListener('DOMContentLoaded', () => {
    const user = getUser();
    if (!user) { location.replace('../users/login.php'); return; }
...
async function loadStats() {
    try {
        const res  = await fetch(`${BASE}/creneaux/stats.php`);
